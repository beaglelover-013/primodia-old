...
酒馆:
  ...
  区域: 动态区域对象。新开局只写当前确定存在/可用的空间，默认包含：主厅接待区、柜台酒水区、厨房餐食区。客房写入下方独立的“客房”对象；前门、地窖、后院、马厩等未成立空间不要预设成区域。每个区域至少写 状态、状态原因、风格、描述、分配员工、设施。
...
琥珀色的眼睛在笑意下面瞥了一眼他赤脚踩在碎石地上的样子--这么冷的天--又看了一眼围裙上那几块洗不掉的油渍，然后重新回到他的脸上，安安静静地等着。尾巴在斗篷底下轻轻晃了一下。`;
  ...
  initvar.库房 = {
    食材: {
      猪肉: { 数量: 2, 每件份数: 6, 当前剩余份数: 6, 标签: ['肉类', '新鲜'], 价格折合铜币: 180 },
      牛肉: { 数量: 1, 每件份数: 8, 当前剩余份数: 8, 标签: ['肉类', '新鲜'], 价格折合铜币: 280 },
      鸡肉: { 数量: 3, 每件份数: 4, 当前剩余份数: 4, 标签: ['禽肉', '新鲜'], 价格折合铜币: 120 },
      鸡蛋: { 数量: 12, 每件份数: 1, 当前剩余份数: 1, 标签: ['禽蛋', '新鲜'], 价格折合铜币: 24 },
      土豆: { 数量: 15, 每件份数: 1, 当前剩余份数: 1, 标签: ['蔬菜', '根茎', '耐储存'], 价格折合铜币: 30 },
      胡萝卜: { 数量: 8, 每件份数: 1, 当前剩余份数: 1, 标签: ['蔬菜', '根茎'], 价格折合铜币: 16 },
      洋葱: { 数量: 6, 每件份数: 1, 当前剩余份数: 1, 标签: ['蔬菜', '调味'], 价格折合铜币: 12 },
      卷心菜: { 数量: 3, 每件份数: 1, 当前剩余份数: 1, 标签: ['蔬菜', '叶菜'], 价格折合铜币: 15 },
      面粉: { 数量: 1, 每件份数: 10, 当前剩余份数: 10, 标签: ['谷物', '主食', '粗粮'], 价格折合铜币: 50 },
    },
    调料: {
      盐: { 数量: 1, 每件份数: 20, 当前剩余份数: 20, 标签: ['基础调料', '耐储存'], 价格折合铜币: 40 },
      粗糖: { 数量: 1, 每件份数: 8, 当前剩余份数: 8, 标签: ['甜味', '基础调料'], 价格折合铜币: 32 },
      黑胡椒: { 数量: 1, 每件份数: 6, 当前剩余份数: 6, 标签: ['香料', '贵重'], 价格折合铜币: 60 },
    },
    成品: {},
    酒水: {
      啤酒: { 数量: 1, 每件份数: 20, 当前剩余份数: 20, 标签: ['麦酒', '低度', '日常'], 价格折合铜币: 100, 搭配判定: '无冲突' },
      麦酒: { 数量: 1, 每件份数: 15, 当前剩余份数: 15, 标签: ['麦酒', '中度', '农家'], 价格折合铜币: 90, 搭配判定: '无冲突' },
    },
    杂物: {
      麻绳: { 数量: 2, 每件份数: 1, 当前剩余份数: 1, 标签: ['工具', '修缮'], 价格折合铜币: 10 },
      旧木桶: { 数量: 3, 每件份数: 1, 当前剩余份数: 1, 标签: ['容器', '空桶'], 价格折合铜币: 15 },
    },
    日用品: {
      蜡烛: { 数量: 8, 每件份数: 1, 当前剩余份数: 1, 标签: ['照明', '消耗品'], 价格折合铜币: 16 },
      灯油: { 数量: 1, 每件份数: 10, 当前剩余份数: 10, 标签: ['照明', '消耗品'], 价格折合铜币: 30 },
      柴火: { 数量: 1, 每件份数: 15, 当前剩余份数: 15, 标签: ['燃料', '消耗品'], 价格折合铜币: 30 },
      肥皂: { 数量: 2, 每件份数: 1, 当前剩余份数: 1, 标签: ['清洁', '消耗品'], 价格折合铜币: 10 },
      布匹: { 数量: 1, 每件份数: 1, 当前剩余份数: 1, 标签: ['修缮', '材料'], 价格折合铜币: 25 },
      水: { 数量: 1, 每件份数: 30, 当前剩余份数: 30, 标签: ['消耗品', '每日消耗'], 价格折合铜币: 0 },
    },
  };
