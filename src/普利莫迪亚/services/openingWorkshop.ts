...
export function buildFixedOpeningPreset(worldbookName = '', keepInitvarForBranch = false): {
  ...
  const fixedMaintext = `解冻月阴沉的天光薄得透，从丘陵东面的白桦林里慢吞吞地漫过来，在布拉姆维克村口那条还没完全干透的泥路上铺了一层发冷的灰白。路边的雪化了大半，只在背阴的石墙根底下残着一小条灰白的冰碴子，被脚印和车辙碾成了碎渣，和泥土搅在一起，踩上去发出湿软的吱嘎声。空气还是冷的，带着初春解冻时特有的泥土腥气，远处牧羊坡飘来的淡淡膻味，以及一缕若有若无的、来自某户人家烟囱的木柴烟。村子不大，三十来户人家沿着丘陵缓坡散落，石砌的矮屋顶上长着去年没来得及清理的枯草。远处磨坊的水轮开始转了——化冻的溪水刚恢复流量，吱呀声在清冷的空气里传出很远，和某个院子里一下一下劈柴的沉闷声混在一起，构成了这个春天早晨最主要的声响。

一条橘棕色的大尾巴从泥路那头摇摇晃晃地靠近了。

尾巴的主人裹在一件起球的深灰色旧斗篷里，兜帽拉得不太高，露出两只大三角的狐耳——耳尖是黑的，内侧透着粉色的绒毛，正不安分地左右转动着，各自独立扫描不同方向。她走路几乎没有声音，兽爪半靴的前端敞开着，露出覆着短毛的爪子和粉色的肉垫，踩在半融的泥地上只留下浅浅的、几乎不带脚跟的印子。斗篷底下的尾巴太蓬松了，把布料撑出一个不规则的鼓包，走路时一摆一摆的。

泥土的湿气、远坡上的羊膻味、烟囱松脂混着硬木的烟——这些气味从她鼻子前面流过去，她都没怎么上心。直到风向微微一偏，带来了一股谷物煮过头之后留在空气里的焦甜气。她的耳朵先于脑子朝那个方向转了过去，步子也跟着偏了一点。
...
她盯着那几个字看了两秒钟。手指不自觉地摸上了腰间那个已经磨出毛边的旧布袋，隔着布摸到了里面几枚铜板的形状——明明知道只有八个，指尖还是一枚一枚地点过去。耳朵往两边塌了一下，又立起来。离心心念念的"铁心脏"还有半个月路程，连一晚大通铺都住不太起。蹭两天吃住，攒点体力和路费，再上路。她的视线顺着告示牌朝村子里面看去，在缓坡偏南的位置看到了一栋两层的石砌矮楼，一楼有扇木门，门边挂着一块同样风化得厉害的木牌，上面的字从这个距离看不清，但形状是杯子的简笔画。
...
屋里比外面暖。闷了一夜的、灶台余温和木头墙壁慢慢沁出来的温吞暖意。她的尾巴在斗篷底下不自觉地松了松——走了一早上的路，到现在才发现自己的毛一直是竖着的。

酒馆比她预想的还小一些。六张木桌散落在前厅里，桌面擦过但没擦干净，靠窗那张的角落里还残着一圈干涸的水渍。椅子是粗木拼的，有几把缺了横档。地面是石板铺的，踩上去脚感粗粝。右手边是厨房方向，一道布帘半掩着，帘子后面传来极微弱的咕嘟声——她的耳朵朝那个方向歪了歪，鼻子跟着吸了一下。谷物焦甜味更浓了，混着一股铁锅被烧热又冷却后特有的金属涩气。整个空间弥漫着一种"有人在用但没什么人来"的气息，干净是干净的，但那种干净透着寡淡。

她的目光扫完了整个前厅——没有客人，一个都没有——最后落在了柜台后面。

柜台是一块厚实的老榆木架在两个酒桶上，后面的架子上挂着几排锡酒杯和两只半满的酒桶。一个人半靠在柜台上——一只手臂搁在木面上，手指头在柜台的木纹上慢慢地划来划去，顺着年轮的弧线描。目光是放空的，看着柜台对面的某处，又不在看任何具体的东西。身上穿着一件洗得发白的亚麻衬衫，袖子卷到小臂，小臂上有一道淡旧的烫伤疤痕——灶上留下来的那种。腰间系着一条牛皮围裙，围裙面上有几块洗不掉的油渍，但围裙带子系得很整齐，是做过很多次的肌肉记忆式的蝴蝶结。

她在门口站了大约五秒钟。那个人完全没有反应。手指继续在木纹上划，目光继续放空，呼吸平稳得像是这个世界上除了那块木头以外什么都不存在。她的耳朵不确定地朝他的方向转了转——确认了，他没注意到有人进来。灶火、木柴烟、隔夜的麦粥、微微的汗味——他身上的气味和这间屋子的气味混在一起，几乎分不出哪个是人哪个是酒馆。

她悄悄把斗篷的兜帽往后拨了拨，露出额前的碎发和两只立起来的耳朵。手指拨了拨耳朵旁边垂下来的几缕头发。

"——那个，打扰了。"

她的声音不高，带着一点从外面冷空气里走进来之后还没完全回暖的微哑，句尾拖了一个小小的尾音。柜台后面的手指停住了，目光从木纹上离开，慢了半拍才转过头来看她。视线对上的瞬间他眨了两下，确认面前真的站了一个人。

她的耳朵不自觉地微微前倾了一点。这个"老板"和告示牌给她的预期不太一样。

但嘴已经比脑子快了——从小在铺子里泡出来的习惯让她没过脑子就挂上了笑，嘴角翘起来，露出一点点小犬牙，语气随意："村口告示牌上那个'招人'——还算数吗？"

琥珀色的眼睛在笑意下面瞥了一眼他的围裙上那几块洗不掉的油渍，然后重新回到他的脸上，安安静静地等着。尾巴在斗篷底下轻轻晃了一下。`;
    ...
    酒馆: {
      ...
      区域: {
        主厅接待区: {
          ...
          风格: '丘陵村口旧酒馆前厅',
          描述:
            '六张木桌散落在前厅，桌面擦过但没擦干净，靠窗那张的角落里还残着一圈干涸的水渍。椅子是粗木拼的，有几把缺了横档。地面是石板铺的，踩上去脚感粗粝。空气里弥漫着谷物煮过头后的焦甜气，混着陈年木头和铁锅锈气。',
          分配员工: '',
          设施: {
            木桌: {
              状态: '良好',
...
说"一团"是因为那个身影的轮廓确实更接近"一团"而不是"一个"——蓬松的纯白卷毛从头顶蔓延到肩膀，从一件深灰蓝色收腰短大衣的领口和袖口冒出来，在阳光和融雪的反光里白得几乎透明。偶蹄踩进泥地没有声音，拔出来带起一小团泥水，留下浅浅的双瓣印。残雪是白的，白桦树干是白的，她也是白的——在这个所有东西都在反光的正午，这个身影差一点就融进了风景里。差一点，因为脸是黑的。浓墨一样的纯黑覆盖了整个面部，从额头到下巴，嵌在白卷毛正中间。一对浅琥珀色的大眼睛在黑色面孔上格外醒目，瞳孔是横的，正缓慢调整，适应没有遮拦的阳光。鼻尖圆钝，微微泛粉，是整张脸上唯一不是纯黑的地方。
...
一楼有扇木门，半掩着。门边挂了一块灰木牌，上面画着一只杯子的简笔画。她在门前停了下来，盯着那扇门看了一会儿。嘴唇动了一下，在默念什么。手指不自觉地去摸腰间小皮包的搭扣——打开，扣上，打开，扣上。耳朵微微后压，又立回来。短大衣下摆垂着的那条短尾巴——蓬松白色卷毛裹成的棉花球——开始不易察觉地颤抖。酿造师公会学徒，到韦斯托利亚不到一周，养母让她先从小村庄开始跑，一家一家地来。今天在路上犹豫了太久，已经快过午了，这是唯一还有时间进去的一家。
...
门轴没有响。她推开刚够侧身的宽度，偶蹄跨过门槛——门槛的木头已经磨出了一个浅浅的凹槽——木箱蹭了一下门框，她侧了侧身让它过去。屋里比外面暖。闷了一夜的、从灶台余温和木头墙壁里慢慢渗出来的沉暖。和外面白晃晃的阳光相比屋里是暗的，横瞳用了两三秒调整，琥珀色瞳孔缓慢扩大。

酒馆比她预想的还要小。六张木桌散落在前厅，桌面擦过但没擦干净，角落靠窗那张残着一圈干涸的水渍。椅子粗木拼的，几把缺了横档。石板地面，偶蹄踩上去有一点细碎的骨质碰石声。右手边布帘半掩着，那股谷物焦甜和金属涩气从帘后飘出来，在封闭的空间里浓了几倍。没有客人，一个都没有。整个空间弥漫着一种"有人在用但没什么人来"的感觉——干净是干净的，但那种干净透着寡淡。

她的目光最后落在了柜台的方向。一块厚实的老榆木架在两个酒桶上，后面的架子上挂着几排锡酒杯和两个半满的酒桶。柜台后面有人。她的视线在那个方向停了不到一秒就滑开了，落到柜台面上一只倒扣的陶杯上——耳朵替她做了确认，朝那个方向微微转了一下，捕捉到了呼吸声和布料偶尔蹭动的细微声响。活人，在那里。嗓子眼已经开始发紧了。

她应该开口了。"您好我是酿造师公会的"——这句话排练了一路，此刻在嗓子眼卡了一下。嘴张开，气到了舌尖，没出声，又关上了。手指去弹腰间搭扣，发出极轻的金属声。再张开，又没出声。柜台后面那个人也没注意到她进来——整个前厅安安静静的，只有布帘后灶台上什么东西极小声地咕嘟，和从门缝渗进来的屋檐滴水声。她站在门和柜台之间的空地上，背着木箱，挂着牌子，白色卷毛在昏暗的室内像一团不太确定自己该不该出现在这里的云。五秒，十秒。她感觉过了很久，大概只有十几秒。她一定要开口，这是她的工作，养母在等她回去汇报。

她第三次张开嘴，然后身后一阵风灌了进来。

她进来的时候没有把门关严。融雪午后的风不冷但莽，灌进来的一瞬间裹着湿泥、融水和被太阳晒热的石头气息，直直扑进了前厅。她站在门和柜台之间正对风口，蓬松的白色卷毛在风里整个炸开了——从头顶到短大衣领口全部朝一个方向飘起来，角上那根歪丝带被吹得直直指向柜台。木牌在风里晃荡，"咔"地一声磕在木箱的背带扣上。耳朵里灌进冷风，粉红绒毛被吹得倒伏。她的双手本能地离开了小皮包——一只去按头顶飞起来的卷毛，一只去扶被风推歪的木箱——身体扭了一下，左蹄在石板地面上滑了半步。门在风里撞开了，门板拍在墙上闷闷一声响，外面的阳光涌进来，刚适应暗处的横瞳猛然收缩，整个视野白了一瞬。

她在那片涌进来的光里僵了大约一秒钟。一只手按着头顶还没顺回去的卷毛，一只手扶着歪了一半的木箱，木牌还在轻轻晃，偶蹄卡在打滑的位置没敢动。阳光从背后打进来，在石板地面上投下一个毛茸茸的、边缘不规则的影子。浅琥珀色的横瞳从飞散的白色卷毛后面，对上了柜台方向看过来的目光。
...
酒馆前厅里，壁炉生着火。初春傍晚安安静静烧着的火，炉膛里的松木偶尔发出一声细小的崩裂。石板地面上铺着一层琥珀色的暖。六张木桌散落在前厅里，桌面擦过了，椅子是粗木拼的。厨房方向飘来谷物煮过之后的焦甜气，混着铁锅被反复烧热又冷却后的金属涩气。布帘半掩着。

门被推开了。

直接推。没有敲。门轴发出一声极短极低的吱呀，停了两秒，然后开大了。偶蹄踩在石板地面上，细碎的骨质碰石声，一步一步，不急。接着是背包蹭过门框的闷响，然后门又关上了。

"……打扰了。"

声音偏柔偏轻，带着走了远路之后的微微哑。

鹿族的偶蹄在石板上又走了几步，然后停了。一个灰褐色的大帆布背包从肩上卸下来，靠着柜台脚放稳。背包落地的声音比看起来沉——帆布吃足了分量，砸在石板上闷闷的一声。直起腰的时候脊背先顿了一下才完全展开，肩上的背带勒痕隔着深绿色亚麻长袍也能看到两道压陷的印子。

她的毛色是赤棕的，短密的毛紧贴着皮肤，在壁炉的火光里带着一层温暖的光泽。背侧散布着白色的斑点，不规则排列，从肩膀蔓延到手臂侧面。腹侧渐变成浅沙色，从领口松开的一颗扣子里可见。头顶两只鹿角，约十五厘米，分叉对称——左边那只上挂着一小束干草，颜色褪成了灰绿，但还能看出薄荷叶片的形状，干了很久了。右边那只上挂着另一束，比左边的新，还没完全干透。蜂蜜色的横瞳，耳朵覆着赤棕短毛，安安静静地立在头侧。袍子的下摆沾着泥——走了很多天路，洗过又沾、沾了又洗，沉积下来的暗色痕迹。蹄套边缘磨得发白了。

她的表情很平。走了很久的路之后，脑子里什么都不想的平。腰间一个棕色皮革挎包，金属扣偶尔碰出极轻的一声。她低头解挎包的搭扣——打开，扣上，又打开——然后抬起视线。

蜂蜜色的横瞳朝柜台方向停了一秒。嘴角翘起来一点点，刚好够表示"你好"。

"请问，客房多少钱一晚？"

问完之后安安静静地站着。挎包的金属扣偶尔碰出极轻的一声，角上那束干薄荷在壁炉的暖光里只剩下一个灰绿色的轮廓。`;

export function buildDeerOpeningPreset(worldbookName = ''): {
  draft: OpeningWorkshopDraft;
  bundle: OpeningGenerationBundle;
} {
  const preset = buildFixedOpeningPreset(worldbookName, true);
  ...
  draft.tavern.funds = '6金币';
  draft.tavern.stock = '蔬菜和肉稍多';
  draft.theme = '固定开场白：翠萱傍晚投宿';

  bundle.characterProfile.profile =
    '克斯，14岁，人类。刚接手布拉姆维克村口的铁壶酒馆，穿着洗得发白的亚麻短袖衫、深棕色粗布短裤和旧围裙，赤脚站在柜台后。傍晚壁炉生着火，他被推门进来投宿的鹿族旅人吸引了注意。';
  bundle.characterProfile.summary = '克斯是铁壶酒馆的少年老板，慢半拍但认真，刚开始独自经营酒馆。';
  bundle.tavernProfile.profile =
    '铁壶酒馆位于韦斯托利亚布拉姆维克村口，是一间小型旧酒馆。解冻月的傍晚，前厅壁炉生着火，石板地面铺着琥珀色的暖光，厨房里飘着谷物焦甜气。走了远路的鹿族旅人翠萱背着大帆布背包来到这里投宿。';
  bundle.tavernProfile.summary = '解冻月傍晚，铁壶酒馆壁炉生着火，安静冷清，一位走了远路的鹿族旅人推门进来询问客房。';
  bundle.story.maintext = DEER_OPENING_MAINTEXT;
  bundle.story.options = ['回答翠萱客房的价格'];
  bundle.story.sum = '解冻月傍晚，走了远路的鹿族旅人翠萱背着帆布背包来到布拉姆维克的铁壶酒馆，卸下背包后向柜台后的克斯询问客房价格。';
  ...
  initvar.酒馆.今日营业状态 = '营业中';
  initvar.酒馆.整体概况 =
    '铁壶酒馆冷清，真正能用的是主厅接待区、柜台酒水区、厨房餐食区和二楼几间简陋客房。解冻月的傍晚，前厅壁炉生着火，炉膛里的松木偶尔崩裂一声，石板地面铺着一层琥珀色的暖。';
  initvar.主角.当前状态 = '在柜台后，看着傍晚推门进来投宿的鹿族旅人';
  initvar.库房.食材 = {
    ...initvar.库房.食材,
    新鲜土豆: { 数量: 8, 标签: ['蔬菜', '根茎', '饱腹'], 价格折合铜币: 1 },
    春萝卜: { 数量: 6, 标签: ['蔬菜', '清甜', '水润'], 价格折合铜币: 1 },
  ...
  initvar.人物羁绊.翠萱 = {
    ...
    所在位置: '主厅接待区',
    一句话穿着:
      '深绿色亚麻长袍，下摆沾着沉积的旧泥痕，蹄套边缘磨得发白，腰间挂棕色皮革挎包，肩上勒痕来自一个灰褐色大帆布背包，两只鹿角上各挂着一束干草药。',
    生命: { 当前值: 100, 上限: 100 },
    精力: { 当前值: 46, 上限: 100 },
    膀胱: { 当前值: 35, 上限: 100 },
    个人资金: openingMoneyBucket(320),
    收入: { 职业: '采药人', 日收入折合铜币: 0, 结算方式: '靠卖草药和干货零散结算', 备注: '长途跋涉途中，需要落脚休整。' },
    备注:
...
一个棕色的身影跨过门槛。兔族的后腿弹性让这个动作比实际轻了两倍，厚毛底垫的前脚掌无声落地，人已经站在前厅中间了。脑袋左右转，头顶一对超过半臂长的兔耳竖得笔直，单耳高速旋转，朝不同方向扫。手没闲着——经过靠门那张桌子时指尖已经在桌面上划了一道。

"好小。"

另一个身影在她身后跨过门槛。同样的棕色短绒毛，同样的圆脸，同样的琥珀色大眼。她没跳。脚掌落地一样无声，但节奏不同——稳，匀，不急。她用肩膀把门推回去，门轴吱呀一声，关上了。

前面那个已经绕出去了。手摸了石墙（"凉"），摸了椅子靠背（拍了两下），蹲下去看了一眼桌腿的榫卯（"哦——"，没下文），又站起来把脑袋探向厨房方向的布帘，凑近了鼻子抽两下。耳朵朝布帘后面转了转，然后转回来，对准了柜台方向。

柜台。老榆木，后面架子上挂着锡杯。柜台后面有人。

"老板？"

她已经贴到柜台前面了，两只手撑在台面上，身体前倾，整个人几乎要翻过去看柜台后面到底是什么情况。琥珀色眼睛圆圆的，瞳孔微微放大。棕色棉球尾在身后快速颤了两下。素绉缎交领短衫——月白底子暗织竹叶纹——被她趴在柜台上的动作扯得领口歪了一点，露出锁骨下方棕色渐浅的短绒。嘴角合不太严实，留着一道天生的缝。头顶冠毛用一根银簪别着，碎毛从簪子旁边翘出来，好几根。

后面那个还站在前厅靠门的位置。

她没摸任何东西。两只手垂在身侧，视线从那个位置安静地走过了整面空间——窗，门，布帘，柜台，架子上的杯子和桶。然后她走过来了，站在姐姐身侧半步后的位置，不说话。同样的素绉缎短衫，灰白底，没有暗纹。银簪别的头冠毛服服帖帖，一根碎毛都没翘。嘴唇自然合着。耳朵近乎静止——只在姐姐趴上柜台的时候微微转了一下，然后转回来。斜背的软皮小挎包是烟灰色的，比姐姐那个蜜色的小一号。

两张一模一样的脸。

一个在动，一个在看。一个进门就摸遍了所有东西，一个进门后只动过耳朵。

趴在柜台上的那个已经等不了了。她踮起脚尖——没因此高出多少——又往柜台里面探了探。

"有人嘛——我们想吃东西，有吃的吗？住也行——有客房吗？你们这有什么——妹妹你饿不饿——反正我饿了——"

后面那个没接话。她的耳朵在姐姐连珠炮的时候转了半圈，但眼睛不在姐姐身上——还在柜台后面那个人的方向。安安静静的。在看。`;

export function buildTwinsOpeningPreset(worldbookName = ''): {
  draft: OpeningWorkshopDraft;
  bundle: OpeningGenerationBundle;
} {
  const preset = buildFixedOpeningPreset(worldbookName, true);
  ...
  draft.tavern.funds = '6金币';
  draft.tavern.stock = '蔬菜和肉稍多';
  draft.theme = '固定开场白：莲家双子上门';

  bundle.characterProfile.profile =
    '克斯，14岁，人类。刚接手布拉姆维克村口的铁壶酒馆，穿着洗得发白的亚麻短袖衫、深棕色粗布短裤和旧围裙，赤脚站在柜台后。开局时一对一模一样的兔族双子推门进来，一个趴上了柜台，一个安静地看着他。';
  bundle.characterProfile.summary = '克斯是铁壶酒馆的少年老板，慢半拍但认真，刚开始独自经营酒馆。';
  bundle.tavernProfile.profile =
    '铁壶酒馆位于韦斯托利亚布拉姆维克村口，是一间小型旧酒馆。前厅有六张木桌、老榆木柜台、锡杯和半满酒桶，厨房布帘后传来极小声的咕嘟。一对一模一样的兔族双子莲洵和莲沁推门进来，问吃的和客房。';
  bundle.tavernProfile.summary = '铁壶酒馆冷清但可营业，一对性格截然相反的兔族双子推门进来，前厅一下子热闹了。';
  bundle.story.maintext = TWINS_OPENING_MAINTEXT;
  bundle.story.options = ['回应莲洵，招呼这对兔族双子'];
  bundle.story.sum = '一对一模一样的兔族双子来到布拉姆维克的铁壶酒馆：姐姐莲洵摸遍前厅后趴上柜台连珠炮地问吃住，妹妹莲沁安静地站在半步后打量着柜台后的克斯。';

  const initvar = bundle.story.initvar as Record<string, any>;
  initvar.世界.当前历法.天气 = '多云，融雪继续，泥路半干';
  initvar.世界.当前历法.时间 = '13:40';
  initvar.酒馆.资金 = {
    随身钱袋: openingMoneyBucket(6000),
    钱匣: openingMoneyBucket(0),
  };
  initvar.酒馆.今日营业状态 = '营业中';
  initvar.酒馆.整体概况 =
    '铁壶酒馆冷清，真正能用的是主厅接待区、柜台酒水区、厨房餐食区和二楼几间简陋客房。门外是布拉姆维克村口半干不干的泥路，前厅刚被一对兔族双子的动静打破了安静。';
  initvar.主角.当前状态 = '在柜台后，被趴上柜台的兔族双子姐姐问得一时接不上话';
  initvar.库房.食材 = {
    ...initvar.库房.食材,
    新鲜土豆: { 数量: 8, 标签: ['蔬菜', '根茎', '饱腹'], 价格折合铜币: 1 },
    春萝卜: { 数量: 6, 标签: ['蔬菜', '清甜', '水润'], 价格折合铜币: 1 },
  ...
  initvar.人物羁绊.莲洵 = {
    ...
    所在位置: '主厅接待区',
    一句话穿着:
      '月白底暗织竹叶纹的素绉缎交领短衫，领口被趴柜台的动作扯歪了一点，头顶冠毛用银簪别着但碎毛翘出好几根，斜背蜜色软皮小挎包。',
    生命: { 当前值: 100, 上限: 100 },
    精力: { 当前值: 88, 上限: 100 },
    膀胱: { 当前值: 22, 上限: 100 },
    个人资金: openingMoneyBucket(150),
    收入: { 职业: '旅行者', 日收入折合铜币: 0, 结算方式: '和妹妹共用旅费', 备注: '钱大多在妹妹莲沁那里保管。' },
    备注:
      '莲洵是莲家双子中的姐姐，棕色短绒毛，圆脸，琥珀色大圆眼，头顶一对超过半臂长的兔耳会单耳高速旋转，棕色棉球尾兴奋时快速颤动，嘴角天生合不太严实留着一道缝。她进门就摸遍了前厅所有东西，说话连珠炮，好奇心和行动力都极强，先动手后动脑。和妹妹莲沁长着一模一样的脸。偏好：吃的、新鲜事物、被顺着聊、摸来摸去。',
  };
  initvar.人物羁绊.莲沁 = {
    种族: '兔族',
    身份: '结伴旅行的双子妹妹',
    ...
    所在位置: '主厅接待区',
    一句话穿着:
      '灰白底无暗纹的素绉缎交领短衫，银簪别的头冠毛服服帖帖一根碎毛都没翘，斜背烟灰色软皮小挎包，比姐姐那个小一号。',
    生命: { 当前值: 100, 上限: 100 },
    精力: { 当前值: 84, 上限: 100 },
    膀胱: { 当前值: 18, 上限: 100 },
    个人资金: openingMoneyBucket(1200),
    收入: { 职业: '旅行者', 日收入折合铜币: 0, 结算方式: '保管两人共用旅费', 备注: '双子的旅费主要由她掌管。' },
    备注:
